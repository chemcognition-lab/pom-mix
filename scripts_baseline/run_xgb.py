...
from pommix_utils import create_tvt_split_indices, augment_mixture_pairs
...
if __name__ == '__main__':
    ...
    for feat_type in ['rdkit2d', 'pom_embeddings']:
        ...
        for id, train, val, test in sl.load_splits(dl.features, dl.labels):
            ...
            # will have to flatten features along mixture dimension
